		<header class="header">
            <a href="index.html" class="logo">
                ...
                <?php echo img(array('src'=>'resources/img/logo-evo.png', 'alt'=> 'Evolve Interactive', 'width'=>'100', 'height'=>'40'));?>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span><?php echo $session->nombre;?> <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header bg-light-blue">
                                    ...
                                    <?php }?>
                                    <p>
                                        <?php echo $session->nombre." - ".$session->puesto?>                                        
                                    </p>
                                </li>                                
