        ...
        <link href="<?php echo base_url()?>resources/bxslider/jquery.bxslider.css" rel="stylesheet">
        ...
        <script type="text/javascript" src="<?php echo base_url() ?>resources/bxslider/jquery.bxslider.js"></script>
