...
<div class="row wrap-vervideo">
    <div class="col-md-12">
        <br>
        <h2 style="font-size: 50px; letter-spacing: 1px;"><?php echo $this->lang->line('menu_travel') ?></h2>
    </div>
    <div class="col-md-12 menu-map">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="<?php echo base_url("/") ?>"><?php echo $this->lang->line('menu_home') ?></a> /
        <?php echo $this->lang->line('menu_travel') ?>
    </div>
    ...
    <div class="col-md-12" style="margin-bottom: 20px;">
        ...
        <div class="col-md-8">
            <div class="wrap-video">
                <img src="<?php echo base_url("resources/images/video_bg_travel.jpg") ?>" width="100%" height="100%">
            </div>
            <br>
            <p style="font-size: 16px;"><?php echo $this->lang->line('de_paseo_con') ?></p>
            <br>
