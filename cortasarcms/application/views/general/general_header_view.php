			...
			<div class="navbar-custom-menu">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown user user-menu">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img src="<?php echo base_url()?>/resources/images/user-default.jpg" class="user-image" alt="" />
							<span class="hidden-xs"><?php echo $usuario->nombre." ".$usuario->apellidos ?></span>
						</a>
						<ul class="dropdown-menu">
							<!-- User image -->
							<li class="user-header">
								<img src="<?php echo base_url()?>/resources/images/user-default.jpg" class="img-circle" alt="" />
								<p><?php echo $usuario->nombre." ".$usuario->apellidos ?><small><?php echo $usuario->perfil ?></small></p>
							</li>
							<!-- Menu Footer-->
