        ...
        <link href="<?php echo base_url()?>/resources/selectjs/multiple-select.css" rel="stylesheet" type="text/css" />
        ...
        <script src="<?php echo base_url()?>/resources/selectjs/jquery.multiple.select.js" type="text/javascript"></script>