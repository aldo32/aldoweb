...
class Invertir extends CI_Controller {
    ...
    public function index() {
        ...
        //get invertir
        $url = URL_CMS."RestGeneral/obtenerInvertir";
        $params = array();
        $invertir = $this->consumeRest($url, $params);

        $data["invertir"] = json_decode($invertir);
        $this->load->view("invertir_view", $data);
    }
